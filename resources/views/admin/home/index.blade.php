...
<div class="container fs-normal">
  ...
  <div class="row">
    ...
    <div class="col-md-6 d-flex justify-content-end">
      <a href="/u/dashboar" class="btn btn-primary mx-2 py-2 shadow-sm fs-normal align-self-center px-3 mt-n3">
        ...
        <div class="row">
          <div class="col-xl-6 mr-auto">
            <div class="form-group">
              ...
              <input type="text" value="{{ auth()->user()->email }}" readonly placeholder="Email" class="form-control fs-normal form-spacer-20x15 @error('email') is-invalid @enderror" id="email" name="email" data-toggle="tooltip" data-placement="right" value="{{ old('email') }}">
              @error('email')
